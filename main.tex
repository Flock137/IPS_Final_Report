%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% COMPREHENSIVE MIDTERM REPORT - INTELLIGENT PHYSICAL SYSTEMS
% Author: Gemini AI based on provided documents
% Date: November 7, 2025
% Version: 5.0 (Final Corrected Version with all Sections)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{
    ...
    \large Course: Intelligent Physical System (ELEC3080)
    \vspace{2cm}
}
\author{
    \textbf{Group 2:}\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{FrameDesign.png}
   
    \caption{Current Design of The Frame}
    \label{fig:wiring_diagram}
\end{figure}

\subsection{Material Properties for Simulation}
The Finite Element Analysis was conducted using the specific properties of Carbon Fiber (230 GPa), as detailed in Table \ref{tab:material_props}. These anisotropic properties are crucial for an accurate simulation.
...
\paragraph{Hardware Integration Plan:} The physical components are interconnected as shown in the conceptual diagram (Figure \ref{fig:electronics_plan}). The microcontroller serves as the central hub, communicating with the IMU via the I2C bus, receiving pilot commands from the FS-iA6B receiver via PPM, and commanding the four ESCs, which in turn drive the brushless motors.

%--- Placeholder for the electronics integration diagram ---
\begin{figure}[H]
    \centering
     \includegraphics[width=0.7\textwidth]{HardWare&SoftWareSetup.png}
    
    \caption{A conceptual diagram illustrating the interconnection of hardware components and the dual-process software architecture.}
    \label{fig:electronics_plan}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{HarwareTesting.png}
   
    \caption{The initial test setup showing the microcontroller, IMU, and receiver connected, with data being monitored on a laptop.}
...
\begin{itemize}{\textbf{Challenge: Communication Issues (EM Noise)}}]
